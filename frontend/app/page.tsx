...
export default async function HomePage() {
	...
	return (
		<main className="container mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-4xl items-center px-4 py-16">
			<section className="w-full rounded-3xl border border-border/70 bg-card/80 p-10 shadow-sm backdrop-blur">
				<div className="max-w-2xl space-y-4">
					...
					<p className="text-muted-foreground text-lg leading-8">
						Use your organisation account to review availability, submit new bookings,
						and manage existing requests.
					</p>
					<div className="pt-2">
